...
* Propose  			: Rewrite the old iologger, use new String and ArrayList.
* 
* Current Version	: 1.1
* Change Log		: Re-Write..
* Author			: Push Chen
...
namespace Plib
{
	namespace Text
	{
		...
		INLINE String LogLevelWord( LOGLEVEL _llv )
		{
		...
		INLINE LOGLEVEL WordLogLevel( const String & _word )
		{
		...
		public:
			...
			INLINE void SetLogFilePath( const String & _filepath ) {
