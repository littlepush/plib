	...
	namespace Utility
	{
		...
		*/
		...
		private:
			...
			INLINE Plib::Text::String _String( Uint32 _Len, bool _RandomCase = true )
			{
				Plib::Text::String _BasicLine( _Len, 'A' );
		...
		public:
			...
			// Generate a random string.
			INLINE static Plib::Text::String Strings( Uint32 _Len, bool _RandomCase = true )
			{
